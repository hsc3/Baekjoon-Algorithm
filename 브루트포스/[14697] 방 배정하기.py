# [14697] 방 배정하기 / Bronze 2 / 브루트포스
'''
정보 초등학교 6학년 여학생들은 단체로 2박 3일 수학여행을 가기로 했다. 학생들이 묵을 숙소에는 방의 정원(방 안에 있는 침대 수)을 기준으로 세 종류의 방이 있으며, 같은 종류의 방들이 여러 개 있다.
...
def solution() :
    ...
    r1, r2, r3, n = map(int, input().split())
    for x in range(n // r1 + 1) :
        for y in range(n // r2 + 1) :
            for z in range(n // r3 + 1) :
                if r1 * x + r2 * y + r3 * z == n : # 침대 수 계산
                    print(1); 
                    return
    print(0)
